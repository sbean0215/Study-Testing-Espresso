...
import testing.study.test_target_nondefault_window.otheractivity.LongListActivity;
import testing.study.test_target_nondefault_window.otheractivity.ScrollActivity;
...
public class SendActivity extends Activity {
    ...
    public static final String EXTRA_DATA = "androidx.test.ui.app.DATA";
            ...
            case MY_PERMISSIONS_REQUEST_CALL_PHONE: {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    new AlertDialog.Builder(SendActivity.this)
                            .setTitle("notify")
                            .setMessage("permission was granted, yay! Do the phone call. click again button .")
                            .show();
                    ...
                    new AlertDialog.Builder(SendActivity.this)
                            .setTitle("notify")
                            .setMessage("apps target SDK is 23 or higher and your device is running on Android 6.0 or higher, this permission must be needed")
                            .show();
                }
